        ...
        <>
            ...
            {currentWeather === IconImages.defaultIcon ?
                ...
                <>
                    ...
                    <div className='flex flex-col font-neonTilt text-slate-600 text-2xl m-auto'>
                        <span>
                            {data.main ? <h3 className='text-4xl md:text-6xl lg:text-4xl'>{Math.round(data.main.temp)}°C</h3> : null}
                        </span>
                    </div>
                    <div className='flex flex-row gap-6 font-neonTilt text-slate-600 pb-4 items-center justify-evenly w-full m-auto'>
